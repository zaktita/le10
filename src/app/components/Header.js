...
function Header() {
  return (
    <section className="relative flex flex-col items-center justify-center min-h-[60vh] text-center px-4 md:px-8 lg:px-16">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-white font-anton text-5xl sm:text-5xl md:text-4xl lg:text-6xl xl:text-8xl leading-tight">
          INFORMER AVEC <span className="text-orange-500">PASSION</span>
          <br />
          TOUTE UNE <span className="text-orange-500">GÉNÉRATION</span>
        </h1>
        <p className="font-lato text-white text-base md:text-sm  max-w-3xl mx-auto mt-8 leading-relaxed">
